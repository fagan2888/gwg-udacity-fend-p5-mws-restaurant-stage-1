...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiaXZhbmphbmtvIiwiYSI6ImNqbGI4bmFvZDRjbGkzcHA0cW1zMzYxNngifQ.2FNhkhsobPCUJVBd7MGPwA',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  image.alt = DBHelper.imageDescriptionForRestaurant(restaurant); // @ add alt description when crating restaurant cards
